...
# Base paths
BASE_DIR = r"C:\Users\ChristopherCato\OneDrive - clarity-dx.com\Intake AI Agent"
...
6. Additional Considerations (any special instructions, medical history, or important details relevant to the order)
